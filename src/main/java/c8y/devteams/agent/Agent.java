...
import c8y.devteams.agent.configuration.DeviceBootstrapProcessor;
...
public class Agent {
	...
	private DeviceBootstrapProcessor deviceBootstrapProcessor;
	...
	public void init(CredentialsManager credentialsManager, DriversLoader driversLoader) {
